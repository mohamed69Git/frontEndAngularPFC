...
export declare class NzCommentComponent implements OnDestroy, OnInit {
    ...
    ngOnInit(): void;
    ngOnDestroy(): void;
    static ɵfac: ɵngcc0.ɵɵFactoryDeclaration<NzCommentComponent, [null, { optional: true; }]>;
    static ɵcmp: ɵngcc0.ɵɵComponentDeclaration<NzCommentComponent, "nz-comment", ["nzComment"], { "nzAuthor": "nzAuthor"; "nzDatetime": "nzDatetime"; }, {}, ["actions"], ["nz-avatar[nz-comment-avatar]", "nz-comment-content", "*"]>;
}
